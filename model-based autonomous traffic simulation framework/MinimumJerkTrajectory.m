...
ddot_i  = [0 1 2*t_i 3*t_i^2 4*t_i^3 5*t_i^4];  % 0
dddot_i = [0 0 2 6*t_i 12*t_i^2 20*t_i^3];      % 0


t_f = 10;

d_f     = [1 t_f t_f^2 t_f^3 t_f^4 t_f^5];      % 2.5
ddot_f  = [0 1 2*t_f 3*t_f^2 4*t_f^3 5*t_f^4];  % 0
dddot_f = [0 0 2 6*t_f 12*t_f^2 20*t_f^3];      % 0
